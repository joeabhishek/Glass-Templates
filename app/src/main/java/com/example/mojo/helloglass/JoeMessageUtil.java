...
import com.example.mojo.helloglass.glass.GlassConnection;
import com.example.mojo.helloglass.glass.GlassMessagingUtil;
...
public class JoeMessageUtil {
    ...
    public static void send(Proto.Envelope envelope1) throws Exception {

        final Proto.Envelope envelope = envelope1;
...
/*                MainActivity.context.runOnUiThread(new Runnable(){
                ...
                c.registerListener(new GlassConnection.GlassConnectionListener() {
